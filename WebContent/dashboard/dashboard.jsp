...
<head>
  ...
  <!-- Favicons-->
  <link rel="icon" href="<%=baseURL%>images/favicon/favicon-32x32.png" sizes="32x32">
  <!-- Favicons-->
  <link rel="apple-touch-icon-precomposed" href="<%=baseURL%>images/favicon/apple-touch-icon-152x152.png">
  <!-- For iPhone -->
  ...
  <link href="<%=baseURL%>css/materialize.min.css" type="text/css" rel="stylesheet" media="screen,projection">
  <link href="<%=baseURL%>css/style.min.css" type="text/css" rel="stylesheet" media="screen,projection">
    <!-- Custome CSS-->    
    <link href="<%=baseURL%>css/custom/custom.min.css" type="text/css" rel="stylesheet" media="screen,projection">


  <!-- INCLUDED PLUGIN CSS ON THIS PAGE -->
  <link href="<%=baseURL%>js/plugins/prism/prism.css" type="text/css" rel="stylesheet" media="screen,projection">
  <link href="<%=baseURL%>js/plugins/perfect-scrollbar/perfect-scrollbar.css" type="text/css" rel="stylesheet" media="screen,projection">
  <link href="<%=baseURL%>js/plugins/chartist-js/chartist.min.css" type="text/css" rel="stylesheet" media="screen,projection">
</head>
...
<body>
  ...
  <footer class="page-footer">
    ...
    <!--prism-->
    <script type="text/javascript" src="<%=baseURL%>js/plugins/prism/prism.js"></script>
    <!--scrollbar-->
    <script type="text/javascript" src="<%=baseURL%>js/plugins/perfect-scrollbar/perfect-scrollbar.min.js"></script>
    <!-- chartist -->
    <script type="text/javascript" src="<%=baseURL%>js/plugins/chartist-js/chartist.min.js"></script>   
